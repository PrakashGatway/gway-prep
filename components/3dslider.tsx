    ...
    <div className="w-full max-w-6xl mx-auto px-2 sm:px-4 md:px-5 overflow-hidden">
      <Swiper
        ...
        breakpoints={{
          320: {
            spaceBetween: 15,
            coverflowEffect: { stretch: 5, depth: 40, scale: 0.85 }
          },
          480: {
            spaceBetween: 20,
            coverflowEffect: { stretch: 8, depth: 60, scale: 0.9 }
          },
          640: {
            spaceBetween: 30,
            coverflowEffect: { stretch: 15, depth: 80, scale: 0.9 }
          },
          768: {
            spaceBetween: 40,
            coverflowEffect: { stretch: 20, depth: 100, scale: 0.95 }
          },
          1024: {
            spaceBetween: 70,
            coverflowEffect: { stretch: 30, depth: 120, scale: 0.95 }
          }
        }}
        className="students-swiper py-6 sm:py-8 md:py-10 lg:py-12"
      >
              ...
              {({ isActive }) => (
                ...
                >
                  <div
                    className="relative w-full h-full bg-gradient-to-bl bg-[#FE8E6D] from-[#FE8E6D] to-white"
                    // style={{ 
                    //   background: `linear-gradient(to bottom left, ${item?.colorCode || '#FE8E6D'}, #ffffff)` 
                    // }}
                  >
                    <img
                      src={item?.image}
                  ...
                  <div className="p-1.5 sm:px-6 sm:pb-3 text-left">
                    ...
                    <div className="text-xs sm:text-sm font-medium text-neutral-500">Score</div>
                    <div className="text-xl sm:text-2xl md:text-3xl lg:text-2xl font-extrabold text-[#ff5722] leading-none mt-1">
                      {item?.score}
                    </div>
                  </div>
                </div>
