...
export default function Auth({ toggleDrawer }: any) {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-transparent p-4 relative">
            <div className="mx-auto mb-6  top-16 left-0 right-0">
                <img src="https://www.ooshasprep.com/image/logo.png" alt="Logo" className="w-40 mx-auto" />
            </div>
            <motion.div
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {mode === "email" && (
                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    <div className="text-left">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="rounded-3xl border-2 border-gray-400 focus:border-red-500 w-full py-2 px-4 text-gray-900 transition-colors"
                                        />
                                        {errors.email && (
                                ...
                                <button
                                    type="submit"
                                    className="w-full px-6 bg-red-600 text-white font-semibold rounded-2xl py-2 hover:bg-red-700 transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl"
                            ...
                            >
                                <div className="flex items-center mb-6">
                                    <button
                                        ...
                                        className="border-2 border-gray-300 p-2.5 rounded-full mr-3 mb-3 hover:bg-gray-50"
                                    >
                                ...
                                <form onSubmit={handleRegisterSubmit} className="space-y-6">
                                    <div className="text-left">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="rounded-3xl border-2 border-gray-400 focus:border-red-500 w-full py-2 px-4 transition-colors"
                                        />
                                        {errors.name && (
                                            <p className="text-red-500 text-sm mt-2 flex items-center">
                                                <span className="w-2 h-2 bg-red-500 rounded-full mr-2"></span>
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full bg-red-600 text-white font-semibold rounded-2xl py-2 py-6 hover:bg-red-700 transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl mt-4"
                                        disabled={loading}
                                    >
                                        {loading ? (
                                            <div className="flex items-center">
                            ...
                            >
                                <div className="flex items-center mb-6">
                                    <button
                                        ...
                                        className="border-2 border-gray-300 py-2.5 px-2.5 mb-3 rounded-full mr-3 hover:bg-gray-50"
                                    >
                                        <ArrowLeft className="w-5 h-5" />
                                    </button>
                                    <div>
                                ...
                                <div className="text-left">
                                    ...
                                    <input
                                        ...
                                        required
                                        maxLength={6}
                                        className="rounded-3xl border-2 border-gray-400 focus:border-red-500 w-full py-2.5 px-4 text-center text-lg font-mono tracking-widest transition-colors"
                                    />
                                    {errors.otp && (
                                        <p className="text-red-500 text-sm mt-2 flex items-center">
                                            <span className="w-2 h-2 bg-red-500 rounded-full mr-2"></span>
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-red-600 text-white font-semibold rounded-2xl px-4 py-2 hover:bg-red-700 transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl"
