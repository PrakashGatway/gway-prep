...
//           y,
//         }}
//         className={`w-full max-w-5xl rounded-2xl md:rounded-[40px] overflow-hidden border-2
//            border-gray-300 flex flex-col lg:flex-row items-center
//           ${index % 2 === 0 ? "bg-[#FEFBEA]" : "bg-[#FDF4EF]"}
//           ${index % 2 !== 0 ? "lg:flex-row-reverse" : ""}`}
//       >
//         {/* Image */}
...
//       {/* Top Banner */}
//       <div
//         className="w-full bg-[#f06437] text-white rounded-2xl md:rounded-[30px] px-6 md:px-12 lg:px-20 py-6 md:py-8 flex
//        flex-col md:flex-row items-center justify-between gap-4 md:gap-6 mb-8 md:mb-12 shadow-sm"
//       >
...
//           />
//         </div>
//         <a href={`https://wa.me/9166146538?text=Hello`} target="_blank" className="bg-white hover:bg-gray-100 text-black font-semibold py-2.5 px-6 rounded-full text-sm transition-colors duration-200 whitespace-nowrap w-full md:w-auto">
//           {cta_banner?.buttonText || ""}
//         </a>
//       </div>
...
//                   "Want to go further? We also include 290+ curated lessons shaped by student feedback to deliver material in the way you learn best."}
//               </p>
//               <button onClick={() => router.push("/auth")} className="mt-8 md:mt-10 bg-[#F36C45] hover:bg-[#ec5d34] transition-all duration-300 text-white font-semibold rounded-xl px-8 md:px-10 py-3 md:py-4 text-base md:text-lg shadow-lg w-full sm:w-auto">
//                 {videoData?.["button-text"] || "Watch Solution Now"}
//               </button>
//             </div>
...
//                     <Play
//                       size={28}
//                       className="md:w-[34px] md:h-[34px] ml-1 text-[#333333]"
//                       fill="currentColor"
//                     />
//                   </button>
//                 </div>
...
//                   />
//                   <div>
//                     <h4 className="text-lg md:text-xl font-semibold text-[#333333]">
//                       By Roshni
//                     </h4>
...
//               __html:
//                 resourcesData?.title ||
//                 "<h2 className='text-3xl md:text-4xl lg:text-5xl font-semibold'><span className='text-[#222]'>Free GRE </span><span className='text-[#F5632A]'>Prep Resources</span></h2>",
//             }}
//           />
//         </div>
...
//                 {item.description}
//               </p>
//               <div className="mt-4 flex items-center gap-3 md:gap-4" onClick={() => router.push("/auth")}>
//                 <button
...
//               <button onClick={() => router.push('/auth')} className="rounded-xl bg-white px-6 md:px-8 py-3 md:py-4 font-semibold text-[#FF5B36] transition hover:scale-105 hover:shadow-xl text-sm md:text-base">
//                 Try Free for 3 Days →
//               </button>
...
//             <button 
//               onClick={() => router.push('/auth')}
//               className="bg-[#424242] hover:bg-[#323232] rounded-full pl-6 pr-2 py-2 flex items-center gap-4 transition-all">
...
//               <button className="bg-gray-700 text-white px-6 py-3 rounded-xl flex gap-2" onClick={() => router.push('/auth')}>
//                 <Play />{" "}
//                 {officialQuestionsSection.buttonText || "Preview Dashboard"}
//               </button>
//             </div>
...
//             </h2>
//             <div className="pt-2">
//               <button onClick={() => router.push("/auth")} className="bg-[#FF6A39] hover:bg-[#e05626] text-white font-bold px-8 py-3 rounded-xl shadow-md transition text-sm md:text-base">
//                 {boostProfileSection.buttonText || "Enroll Now"}
//               </button>
//             </div>
//           </div>
...
//           <p className="my-4 md:my-6 text-sm md:text-base text-center">
//             {scoreGuaranteeSection.subtitle}
//           </p>
//         </div>
