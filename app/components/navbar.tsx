          ...
          <div className="flex items-center justify-between py-3">
            ...
            <div className="hidden lg:flex items-center gap-1 xl:gap-2">
              {navItems.map((item) => (
                ...
                >
                  <Link
                    href={item.href}
                    className={`flex items-center gap-1.5 px-4 py-2.5 text-sm font-medium rounded-2xl transition-all duration-200
                      ...
                      <div className="bg-white rounded-2xl border border-gray-100 shadow-xl overflow-hidden">
                        <div className="px-6 py-4 border-b bg-gradient-to-r from-amber-50 to-orange-50">
                          <h3 className="font-semibold text-gray-800 flex items-center gap-2">
                            <GraduationCap className="text-[#F36C45]" size={18} />
                        ...
                        <div className="p-3 max-h-[420px] overflow-y-auto">
                          {item.dropdownItems?.map((dd: any, idx: number) => (
                            ...
                            >
                              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-100 to-amber-100 flex items-center justify-center flex-shrink-0 overflow-hidden">
                                {dd.img ? (
                                  <Image
                                    src={dd.img}
                                    alt={dd.name}
                                  ...
                                  <GraduationCap size={22} className="text-[#F36C45]" />
                                )}
                              </div>
                              ...
                              <ArrowRight className="text-gray-300 group-hover:text-[#F36C45] mt-1.5 transition-transform group-hover:translate-x-0.5" size={16} />
                            </Link>
                          ))}
                        </div>
                      </div>
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              {!user?.email ? (
                ...
                <button
                  onClick={() => (window.location.href = "https://dashboard.ooshasprep.com")}
            ...
            >
              <div className="p-6">
                ...
                <div className="space-y-2">
                  {navItems.map((item) => (
                    <div key={item.name} className="border-b border-gray-100 last:border-none pb-1">
                      {item.hasDropdown ? (
                        <>
                          <button
                                ...
                                {item.dropdownItems?.map((sub: any) => (
                                  ...
                                  >
                                    ...
                                    <div className="w-10 h-10 rounded-xl bg-orange-100 flex items-center justify-center flex-shrink-0">
                                      {sub.img ? (
                                        <Image src={sub.img} alt="" width={36} height={36} />
                                      ) : (
                                        <GraduationCap size={20} className="text-[#F36C45]" />
                                      )}
                                    </div>
                                    <div>
                                      <div className="font-medium group-hover:text-[#F36C45]">{sub.name}</div>
                                      <div className="text-xs text-gray-500 line-clamp-2">{sub.description}</div>
                                    </div>
                                  </Link>
                                ))}
                              </motion.div>
