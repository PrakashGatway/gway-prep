...
const AdminLoginPage = () => {
  ...
  async function handleSubmit(
    ...
    try {
      ...
      // JWT is already stored securely by the API
      // in the httpOnly adminToken cookie.
      ...
      <div className="w-full max-w-md bg-white shadow-xl rounded-2xl p-6 sm:p-8">
        ...
        >
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full h-10 rounded-lg bg-orange-600 text-white text-sm font-medium hover:bg-[#f26e46] active:scale-[0.98] transition disabled:opacity-60"
          >
...
//       document.cookie = `token=${data.adminToken}; path=/; SameSite=Lax${maxAge}`;
//     }
...
//             hover:bg-[#f26e46] active:scale-[0.98] transition disabled:opacity-60"
//           >
//             {isLoading ? "Signing in..." : "Sign in"}
//           </button>
//         </form>
