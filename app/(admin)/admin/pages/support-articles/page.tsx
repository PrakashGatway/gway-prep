...
import CreateSupportArticle, {
  EditSupportArticlePage,
} from "../../components/createSupportTicket";
import CreateCategory, {
  EditCategory,
} from "../../components/createSupportCategory";
...
export default function SupportArticlesPage() {
  ...
  const fetchArticles = async () => {
    try {
      ...
      if (debounce?.trim()) {
        params.append("search", debounce.trim());
      }
                              ...
                              <td className="px-4 py-4">
                                <div className="flex items-center gap-3">
                                  ...
                                  <div className="min-w-0">
                                    ...
                                    <p
                                      className="mt-1 max-w-[330px] truncate text-[11px] text-gray-400"
